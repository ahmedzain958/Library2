...
class AdapterPatternLinkedInActivity : AppCompatActivity(), View.OnTouchListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.library2.R.layout.activity_adapter_pattern_linked_in)
