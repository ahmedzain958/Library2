...
package com.example.library2.google.ui
...
object NumberOfSetsBindingAdapters {
     ...
     * Ahmed Zain's comment: called when reading the edit text value after you change it from the UI to convert it at the end (after passing through multiple methods) to be
     * for ex 1/6(1: [com.example.android.databinding.twowaysample.data.IntervalTimerViewModel.numberOfSetsElapsed] and
     * the 6: [com.example.android.databinding.twowaysample.data.IntervalTimerViewModel.numberOfSetsTotal] ) or 1/55 ...
     */
