...
package com.example.library2.google.data
...
import com.example.library2.google.util.ObservableViewModel
import com.example.library2.google.util.Timer
import com.example.library2.google.util.cleanSecondsString
import java.util.*
import kotlin.math.round

const val INITIAL_SECONDS_PER_WORK_SET = 5 // 5 Seconds work
const val INITIAL_SECONDS_PER_REST_SET = 2 // 2 Seconds rest
const val INITIAL_NUMBER_OF_SETS = 5 // 5 sets / rounds
...
class IntervalTimerViewModel(private val timer: Timer) : ObservableViewModel() {
    ...
    var timerRunning: Boolean
        ...
        set(startButtonClicked) {
            // These methods take care of calling notifyPropertyChanged()
            if (startButtonClicked) startButtonClicked()
    ...
    */
    ...
    var numberOfSets: Array<Int> = emptyArray()
        @Bindable get() {
            Log.d("zainco","numberOfSetsElapsed $numberOfSetsElapsed ----- numberOfSetsTotal $numberOfSetsTotal")
...
//state of the workout on the screen
